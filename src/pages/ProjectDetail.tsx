                              ...
                              <SelectContent className="p-0">
                                <ScrollArea className="h-[220px]">
                                  <div className="flex flex-col">
                                    ...
                                    <SelectItem value="BFA AWAITED">BFA AWAITED</SelectItem>
                                    <SelectItem value="BFA RECEIVED">BFA RECEIVED</SelectItem>
                                    <SelectItem value="ON-HOLD">ON-HOLD</SelectItem>
                                    <SelectItem value="SENT FOR IFC">SENT FOR IFC</SelectItem>
